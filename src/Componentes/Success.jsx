    ...
    <div className='border-2 border-red-800 py-12 bg-[#F3F2EF]'>
        <div className='border border-black w-[85%] mx-auto py-5'>
            <div className='flex flex-col justify-center items-center '>
                ...
                {/* Cards */}
            <div className='border border-red-400 mt-3.5 p-2 w-full flex justify-between'>
                    ...
                    <div className=' w-[30%] py-2.5 flex flex-col  bg-white p-2 rounded-2xl '>
                        ...
                        <div className=' my-2.5'>
                                <p>In my industry, first impressions are crucial. MeinProfilbild.de turned my selfie into an application photo that was not only professional but also authentic. I've received nothing but positive feedback!</p>
                        </div>

                        <div className=' flex items-center justify-evenly'>
                            <div className='border border-blue-400 bg-[#F3F2EF] flex flex-col gap-2'>
                                <img src={Card1Left1} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card1Left2} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card1Left3} alt="card images" className='h-[164px] w-[164px]' />
                            </div>
                             <div className='border border-blue-400 bg-white flex flex-col gap-2'>
                                <img src={Card1Right1} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card1Right2} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card1Right3} alt="card images" className='h-[164px] w-[164px]' />
                            </div>
                    ...
                    <div className=' w-[30%] py-2.5 flex flex-col  bg-white p-2 rounded-2xl '>
                        ...
                        <div className=' my-2.5'>
                                <p>As a recent graduate, I had neither the time nor the money for a professional photoshoot. MeinProfilbild.de enabled me to have a first-class application photo, and in a very short time. I'm convinced this contributed to my successful job entry.</p>
                        </div>

                        <div className=' flex items-center justify-evenly'>
                            <div className='border border-blue-400 bg-[#F3F2EF] flex flex-col gap-2'>
                                <img src={Card2Left1} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card2Left2} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card2Left3} alt="card images" className='h-[164px] w-[164px]' />
                            </div>
                             <div className='border border-blue-400 bg-white flex flex-col gap-2'>
                                <img src={Card2Right1} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card2Right2} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card2Right3} alt="card images" className='h-[164px] w-[164px]' />
                            </div>
                    ...
                    <div className=' w-[30%] py-2.5 flex flex-col  bg-white p-2 rounded-2xl '>
                        ...
                        <div className=' my-2.5'>
                                <p>I've always had trouble looking good in photos, especially for job applications. With MeinProfilbild.de, I was finally able to get a photo that shows me at my best. This has definitely improved the quality of my applications.</p>
                        </div>

                        <div className=' flex items-center justify-evenly'>
                            <div className='border border-blue-400 bg-[#F3F2EF] flex flex-col gap-2'>
                                <img src={Card3Left1} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card3Left2} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card3Left3} alt="card images" className='h-[164px] w-[164px]' />
                            </div>
                             <div className='border border-blue-400 bg-white flex flex-col gap-2'>
                                <img src={Card3Right1} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card3Right2} alt="card images" className='h-[164px] w-[164px]' />
                                <img src={Card3Right3} alt="card images" className='h-[164px] w-[164px]' />
                            </div>
